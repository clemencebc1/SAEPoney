...
ALTER TABLE SOLLICITER ADD FOREIGN KEY (NUMCOURS) REFERENCES SEANCE(NUMCOURS);
ALTER TABLE SOLLICITER ADD FOREIGN KEY (NUMCOURS) REFERENCES SEANCE(IDSEANCE);

ALTER TABLE ENCADRER ADD FOREIGN KEY (IDMON) REFERENCES MONITEUR(IDMON);
ALTER TABLE ENCADRER ADD FOREIGN KEY (NUMCOURS) REFERENCES SEANCE(NUMCOURS);
ALTER TABLE ENCADRER ADD FOREIGN KEY (NUMCOURS) REFERENCES SEANCE(IDSEANCE);

ALTER TABLE PARTICIPER ADD FOREIGN KEY (IDADH) REFERENCES ADHERENT(IDADH);
ALTER TABLE PARTICIPER ADD FOREIGN KEY (NUMCOURS) REFERENCES SEANCE(NUMCOURS);
ALTER TABLE PARTICIPER ADD FOREIGN KEY (NUMCOURS) REFERENCES SEANCE(IDSEANCE);

ALTER TABLE ETRE_PRESENT ADD FOREIGN KEY (IDFAC) REFERENCES FACTURE(IDFAC);
