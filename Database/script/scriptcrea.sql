...
CREATE TABLE SEANCE (
    ...
    PRIMARY KEY (IDSEANCE, NUMCOURS, DATE_SEANCE)
...
ALTER TABLE ENCADRER ADD FOREIGN KEY (IDSEANCE, NUMCOURS,DATEENC) REFERENCES SEANCE(IDSEANCE, NUMCOURS,DATE_SEANCE);
